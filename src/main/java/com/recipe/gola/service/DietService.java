...
public class DietService {
	...
	public List<RecipeDTO> list(String kcal, String mealType, String schTxt) {
		...
		while(true) {
			...
			list = dietMapper.list(mealType, schTxt);
			...
			//데이터베이스의 칼로리 총합이 1끼식사 칼로리보다 작으면 while 탈출
			if(sumDbKcal <= targetKcal) {
				System.out.println("dataBase Sum Kcal : "+sumDbKcal);
				break;
			}
